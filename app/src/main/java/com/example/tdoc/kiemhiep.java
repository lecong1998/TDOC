...
public class kiemhiep extends AppCompatActivity {
    ...
    DrawerLayout drawerLayout_kiemhiep;
    Toolbar toolbar_kiemhiep;
    NavigationView navigationView_kiemhiep;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kiemhiep);
        ...
        listView_header = findViewById(R.id.kiemhiep_header);
        ...
        drawerLayout_kiemhiep = findViewById(R.id.drawer_layout_kiemhiep);
        toolbar_kiemhiep = findViewById(R.id.tool_bar_kiemhiep);
        navigationView_kiemhiep = findViewById(R.id.nav_view_kiemhiep);

        setSupportActionBar(toolbar_kiemhiep);

        toolbar_kiemhiep.setNavigationIcon(R.drawable.ic_baseline_menu_24);

        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        navigationView_kiemhiep.bringToFront();

        ActionBarDrawerToggle toggle_kiemhiep = new ActionBarDrawerToggle(this,drawerLayout_kiemhiep,toolbar_kiemhiep,R.string.navigation_drawer_open,R.string.navigation_drawer_close);

        toggle_kiemhiep.syncState();

        navigationView_kiemhiep.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
                ...
                {
                    case R.id.nav_home:
                        Intent intent_home = new Intent(kiemhiep.this,main_home.class);
                    ...
                    case R.id.nav_search:
                        Intent intent_search = new Intent(kiemhiep.this,search.class);
                    ...
                    case R.id.nav_dangxuat:
                        Intent intent_dangxuat = new Intent(kiemhiep.this,dangnhap.class);
                        startActivity(intent_dangxuat);
                        break;
                    case R.id.nav_dangtruyen:
                        if(phanquyen==2)
                        {
                            Intent intent_dangtruyen = new Intent(kiemhiep.this,dangtruyen.class);
                            ...
                            Toast.makeText(kiemhiep.this,"Bạn không có quyền đăng truyện!",Toast.LENGTH_SHORT).show();
                        }

                        break;
                    case R.id.nav_theloai:
                        Intent intent_theloai = new Intent(kiemhiep.this,theloai.class);
        ...
        adapter_truyen = new adapter_truyen(truyenkiemhiep(dulieutruyen.getTruyenArrayList()),this);
        listView = (ListView) findViewById(R.id.listview_kiemhiep);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long d) {
                Intent intent_item = new Intent(kiemhiep.this,view_thongtintruyen.class);
    ...
    public ArrayList<truyen> truyenkiemhiep(ArrayList<truyen> truyenArrayList)
    {
        ArrayList<truyen> truyens = new ArrayList<>();
        for (int i=0;i<truyenArrayList.size();i++)
        {
            if(truyenArrayList.get(i).getTheloai()=="Kiếm hiệp")
            {
    ...
    public void onBackPressed() {
        if(drawerLayout_kiemhiep.isDrawerOpen(GravityCompat.START))
        {
            drawerLayout_kiemhiep.closeDrawer(GravityCompat.START);
